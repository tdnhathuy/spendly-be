...
const pascal = kebab
    ...
    .join("");
/* --------------- Tạo thư mục module ----------------- */
const baseDir = path_1.default.join(__dirname, '..', 'src', 'modules', kebab);
...
for (const [file, content] of Object.entries(templates(kebab, pascal))) {
    fs_1.default.writeFileSync(path_1.default.join(baseDir, file), content.trimStart());
    console.log(`  ➜  ${file}`);
}
/* ==================================================== */
/*            Hàm sinh template cho từng file           */
/* ==================================================== */
function templates(kebab, pascal) {
